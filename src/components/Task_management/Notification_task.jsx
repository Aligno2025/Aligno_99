...
=======
          <div class=''>
            ...
            <p class='font-Roboto text-base font-normal p-10 md:pr-20 pl-0'>The ultimate productivity tool to streamline task management, set deadlines and collaborate effectively, all in one place</p>
>>>>>>> ced7316 (new ajustment)
=======
          <div className=''>
            <h1 className="font-poppins text-2xl font-extrabold">Notifications</h1>
...
=======
      <div>
        ...
        {/* <div>
          <div class='mt-8 md:mt-0'>
            ...
            <p class='font-Roboto text-base font-normal p-10 md:pr-20 pl-0'>Sync your tasks with your favourite calendar applications for a comprehensive view of your deadlines and priorities.</p>
          </div>
      ...
      {/* <div class='flex flex-8/12 gap-4 relative md:mt-0 mt-10 p-5 '>
