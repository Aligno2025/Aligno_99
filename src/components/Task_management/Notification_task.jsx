...
const Notification_task = () => {
  return (
    <div class='h-min md:pb-20 pb-8  '>
      ...
      <div class='grid md:grid-cols-2 md:p-20 p-5 pb-30 '>
        <div>
          <div class=''>
            <h1 class="font-poppins text-2xl font-extrabold">Notifications</h1>
          ...
          <div class='grid  items-center text-center '>
            <form action="" class="relative flex text-gray-400  focus-within:text-gray-600  items-center">
              <MdOutlineMail class='absolute w-5 h-5 ml-3 pointer-events-none text-orange-225' />
              <input
                type="text"
                id="fname"
                name="fname"
        ...
        <div class='relative md:h-60 h-30'>

          <div class='absolute md:left-40 top-[20%] md:top-0 left-20'>
          ...
          <div class='absolute md:top-[30%] top-[80%] z-10 pr-10 md:pr-0'>
            <div class='pt-6 md:pl-4 md:pr-4 pb-6 rounded-2xl mt-3 bg-white font-Roboto shadow-2xl flex justify-center items-center'>
              ...
              <div>
                <h1 class='md:text-lg text-sm font-bold font-Poppins'> Task Completed</h1>
                <p class='md:text-sm text-sm font-Roboto'>you have successfully completed the tasks for this week</p>
              </div>
            </div>
          </div>

          <div class='absolute md:top-[60%] top-[150%] md:left-50 left-20'>
            <div class='pt-6 md:pl-4 md:pr-4 pb-6 rounded-2xl mt-3 bg-white font-Roboto  shadow-2xl flex justify-center items-center'>
              <div>
                <div class="animate-spin inline-block mr-3 size-6 border-[3px] border-current border-t-transparent text-orange-225 rounded-full dark:text-orange-225" role="status" aria-label="loading">
                  <span class="sr-only">Loading...</span>
                </div>
              </div>
              <div>
                <h1 class='md:text-lg text-sm font-bold font-Poppins'>Uploading data</h1>
                <p class='md:text-sm text-xs font-Roboto'>Please wait until data is uploaded, you cannot close this notification yet</p>
              </div>
            </div>
          </div>
      ...
      <div class='grid md:grid-cols-3 relative md:mt-0 mt-10 p-5 '>
        ...
        <div>
          <div class='mt-8 md:mt-0'>
            ...
            <p class='font-Roboto text-base font-normal p-10 md:pr-40 pl-0'>Sync your tasks with your favourite calendar applications for a comprehensive view of your deadlines and priorities.</p>
          </div>
