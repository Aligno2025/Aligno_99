           ...
           {!isLoggedIn ? (
            ...
            <Link to="/Sign_up" className="px-12  py-4 bg-amber-48 border-amber-48 font-Roboto text-base font-medium text-white hover:bg-gray-50/5 border-2 hover:text-amber-48" smooth>
              Get Started
                              ...
                              <button className='md:mt-15 mt-8'>
            <Link to="/" className="px-12  py-4 bg-amber-48 border-amber-48 font-Roboto text-base font-medium text-white hover:bg-gray-50/5 border-2 hover:text-amber-48" smooth>
              Get Started
            </Link>
          </button>
                            )}
