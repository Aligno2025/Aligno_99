...
const Collaboration_team = () => {
  return (
    <div class='md:min-h-screen h-[110%] pt-20 flex justify-center items-center text-center'>
    <div>
        <div class='flex justify-center items-center'><img class='md:w-[60%] w-[40%] md:mx-20' src={img1} alt="" /></div>
