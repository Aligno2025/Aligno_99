...
=======
    <div class='pt-20 md:pb-20 pb-10 pl-5 pr-5 flex justify-center items-center text-center'>
    <div>
        <img class='w-[60%] mx-20' src={img1} alt="" />
        <h1 class=' font-black md:text-4xl text-3xl mt-4'>Your Productivity Powerhouse</h1>
